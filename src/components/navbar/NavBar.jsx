...
const NavBar = () => {
  ...
  return (
    ...
    <div className="nav__container">
      ...
      <header>
        <Link to="/" className="logo" style={{display:"flex", textDecoration:"none"}}>
           <img src={logo} alt="Mi logo" style={{ width: "6rem", marginLeft:"5rem", borderRadius:"50%" }} /> 
        ...
        <nav className={`nav-bar ${isNavActive ? "active" : ""}`}>
          <ul>
            ...
            <li>
              <Link to="/servicios" className="active" onClick={closeNav}>
                Productos
              </Link>
            </li>
            <li>
